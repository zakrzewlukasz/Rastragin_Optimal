...
#Index	Index
		...
		#db = client.evo_dbs
		#collection = client.getCollection("evo_db")

				#collection = client.test.testyy
		#collection.insert_one({})
		#db_names = client.list_database_names()

		##if("evo_db" in db_names):
		##	db = client.evo_db
		##	collection_names = db.list_collection_names()
		##	if("evo_records" in collection_names):
		...
		#	collections = db.list_collection_names() # przypisz liste
		#	print(collections)
